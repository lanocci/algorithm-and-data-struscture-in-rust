...
pub trait Puzzle {
    ...
    fn is_target(&self) -> bool {
        let tile_count = Self::ROW_COUNT.pow(2) as usize;
...
impl EightPuzzle {
    ...
    pub fn solve_naive(&self) -> Self {
        ...
        while let Some(pzl) = q.pop_front() {
            ...
            let space_location_x = pzl.space_idx / Self::ROW_COUNT as usize;
            let space_location_y = pzl.space_idx % Self::ROW_COUNT as usize;
            ...
            for d in directions.iter() {
                ...
                if target_tile_location_x < 0 || target_tile_location_y < 0 || target_tile_location_x >= Self::ROW_COUNT || target_tile_location_y >= Self::ROW_COUNT { continue; }
                let mut u = pzl.clone();
                let new_space_idx = (target_tile_location_x * Self::ROW_COUNT + target_tile_location_y) as usize;
